...
export default async function RelatedPostsSection({ excludeSlug }: { excludeSlug: string }) {
  ...
  return (
    <section className="bg-surface py-16 px-4" aria-labelledby="related-heading">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10">
          ...
          <h2
            id="related-heading"
            className="font-title text-4xl md:text-5xl text-contrast uppercase tracking-wide"
          >
            Veja também
          </h2>
        </div>
