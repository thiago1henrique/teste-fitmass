...
const MOCK_TREE: CategoryNode[] = [
  {
    ...
    links: [
      ...
      { id: 'mock-wa-comercial',title: 'Whatsapp Comercial',  url: 'https://api.whatsapp.com/send/?phone=5541984810567&text=Ol%C3%A1%2C+vim+do+site+e+gostaria+de+mais+informa%C3%A7%C3%B5es+sobre+o+Fitmass&type=phone_number&app_absent=0', description: 'Fale com nosso time comercial',          icon: 'whatsapp'  },
      { id: 'mock-wa-suporte',  title: 'Whatsapp Suporte',    url: 'https://api.whatsapp.com/send/?phone=5541991197018&text=Ol%C3%A1%2C+vim+do+site+e+gostaria+de+ajuda+do+suporte+do+Fitmass&type=phone_number&app_absent=0', description: 'Fale com nosso suporte',                  icon: 'whatsapp'  },
