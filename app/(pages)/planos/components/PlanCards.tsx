...
const plans: Plan[] = [
  {
    ...
    description: 'A porta de entrada para avaliações profissionais com a precisão Fitmass.',
    featured: false,
    badge: null,
    cta: 'Saiba Mais',
  ...
  },
  {
    ...
    description: 'Expanda sua capacidade de análise e ofereça relatórios detalhados para seus alunos.',
    featured: false,
    badge: null,
    cta: 'Saiba Mais',
    ...
    features: [
      ...
      'Gordura Visceral + Taxa Metabólica',
      'Histórico ilimitado + PDF',
      'App para o aluno',
    ],
  },
  {
    ...
    description: 'Gestão avançada, APP White Label com sua marca e suporte prioritário para alta performance.',
    featured: true,
    badge: 'MAIS POPULAR',
    cta: 'Quero o ULTRA',
  ...
  },
  {
    ...
    description: 'Escalabilidade, integração total via API e atendimento dedicado para franquias.',
    featured: false,
    badge: null,
    cta: 'Fale Conosco',
