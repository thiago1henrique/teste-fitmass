...
const INFO = [
  {
    ...
    label: 'Rua Jandaia do Sul, 786 - Emiliano Perneta\nPinhais - PR, 83324-440',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
...
export default function ContactSection() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    window.open(`https://api.whatsapp.com/send/?phone=5541984810567&text=${text}&type=phone_number&app_absent=0`, '_blank')
    setSent(true)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="mt-auto pt-8 border-t border-white/10">
              <p className="font-body text-xs uppercase tracking-widest text-white/30 mb-4">Siga a Fitmass</p>
              <div className="flex items-center gap-3">
                <a
                  href="https://www.instagram.com/fitmass.app"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Instagram"
                  className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-accent hover:border-accent/40 transition-colors duration-200"
                >
                ...
                <a
                  href="https://www.facebook.com/fitmass.app"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-accent hover:border-accent/40 transition-colors duration-200"
                ...
                <a
                  href="https://www.linkedin.com/company/fitmass"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-accent hover:border-accent/40 transition-colors duration-200"
                ...
                <a
                  href="https://www.youtube.com/@fitmass"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                  className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-accent hover:border-accent/40 transition-colors duration-200"
