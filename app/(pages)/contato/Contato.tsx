...
export default function Contato() {
  ...
  return (
    <main
      className="relative bg-contrast min-h-screen overflow-hidden"
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4 pt-36 pb-24">
        ...
        <div className="text-left mb-14">
          ...
          <h1 className="font-title text-4xl md:text-5xl uppercase text-white tracking-wide leading-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-8">
            <p className="font-body text-white/60 text-base leading-relaxed">
              Entre em contato e receba uma demonstração personalizada sem compromisso.
